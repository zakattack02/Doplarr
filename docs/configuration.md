...
| `DISCORD__DM_NOTIFICATIONS`    | `:discord/dm-notifications`    | Boolean | `false`       | When set to `true`, sends request confirmation notifications via Direct Message instead of posting to the channel                          |
